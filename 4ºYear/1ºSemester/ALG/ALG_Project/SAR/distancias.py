...
def dist_levenshtein_thres(str1, str2, thres=2**31):
    ...
    for i in range(1, n + 1):
        for j in range(0, m + 1):
            # Comprobamos la distancia según el threshold para más eficiencia
...
def dist_restringida_thres(str1, str2, thres=2**31):
    ...
    for i in range(1, n + 1):
        ...
        # Si todos los valores de la columna son mayor que el threshold, no se cumple su condición
        if np.min(dl2) > thres:
            return None
