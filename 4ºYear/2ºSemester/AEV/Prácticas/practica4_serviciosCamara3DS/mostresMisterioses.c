/*
  la señal de audio guardada en mostresMisterioses
tiene:
    * 8178 bytes o sizeof(mostresMisterioses)
    * codificados en 8-bit ISDN u-law
    * utiliza una frecuencia de muestreo de 11025
    * y es monofónica, tiene un canal
*/
